...
// 		_T("u"), _T("v"), _T("w"), _T("x"), _T("y"), _T("z") };
	...
	CString m_strChange[NUM_CNT_SPELLING][NUM_CNT_CHANGECHAR] = {
		...
		{ _T("¨Ð"), _T("©Ð"), _T("£Ä"), _T("£ä"), },
		{ _T("¡ô"), _T("¢¤"), _T("¨Ñ"),_T("©Ñ"), _T("¥Å"), _T("£Å"), _T("£å") },
		{ _T("¨Ò"), _T("©Ò"), _T("£Æ"), _T("¢µ"), _T("£Æ"), _T("£æ"), },
		{ _T("£¹"), _T("¨Ó"), _T("©Ó"), _T("£Ç"), _T("£ç"), },
		{ _T("¦¢¦©"), _T("¦²¦¢"), _T("|¦©"), _T("¦§|"),_T("¦²|"), _T("|¦´"), _T("¨Ô"), _T("©Ô"), _T("¥Ç"), _T("£è") },
		{ _T("¥¡"), _T("¥°"), _T("£¡"), _T("£ü"),_T("¢®"), _T("¨Õ"), _T("©Õ"), _T("¥É"), },
		{ _T("¨Ö"), _T("©Ö"), _T("£Ê"), _T("£ê"), },
		{ _T("¢Þ"), _T("¨×"), _T("©×"), _T("¥Ê"), _T("¥ê"),	_T("£Ë"), _T("£ë"), },
		{ _T("¦¦"), _T("¦±"), _T("¦Å"), _T("¦Æ"), _T("¨Ø"),	_T("©Ø"), _T("§¤"), _T("£Ì"), _T("£ì"), },
		{ _T("¨Ù"), _T("©Ù"), _T("§©"), _T("¥Ì"), _T("£Í"), _T("£í"), },
		{ _T("¨Ú"), _T("©Ú"), _T("¥Í"), _T("¥ç"),	_T("£Î"), _T("£î"), },
		{ _T("0"),  _T("¡Û"), _T("¡Ý"),_T("¡Ü"), _T("¢½"), _T("¢Á"), _T("¢Ä"), _T("¢Å"), _T("¨Û"), _T("¥ò") },
		{ _T("¨Ü"), _T("©Ü"), _T("¥Ñ"), _T("£Ð"), _T("£ð"), },
		{ _T("¨Ý"), _T("©Ý"), _T("£Ñ"), _T("£ñ"), },
		{ _T("¢ç"), _T("¨Þ"), _T("©Þ"), _T("£Ò"), _T("£ò"), },
		{ _T("¨ß"), _T("©ß"), _T("£Ó"), _T("£ó"), },
		{ _T("¨à"), _T("©à"), _T("¥Ó"), _T("£Ô"), _T("£ô"), },
		{ _T("¡ú"), _T("¨á"), _T("©á"), _T("¥ô"), _T("£Õ"), _T("£õ"), },
		{ _T("¥¥"), _T("¥´"), _T("¡î"), _T("¡ý"), _T("¨â"),_T("©â"), _T("£Ö"), _T("£ö"), },
		{ _T("¨ã"), _T("©ã"), _T("¥ø"), _T("£×"), _T("£÷"), },
		{ _T("¥ª"), _T("¥¹"), _T("¨ä"), _T("©ä"), _T("¥ö"), _T("£Ø"), _T("£ø"), },
